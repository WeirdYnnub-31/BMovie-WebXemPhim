        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeRating = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewHits", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    ServerName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Quality = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_MovieId_IsApproved",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSources_MovieId_ServerName_Quality_Language",
                table: "MovieSources",
                columns: new[] { "MovieId", "ServerName", "Quality", "Language" });

            migrationBuilder.CreateIndex(
                name: "IX_UserInventoryItems_UserId_MovieId_Type",
                table: "UserInventoryItems",
                columns: new[] { "UserId", "MovieId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_ViewHits_MovieId",
                table: "ViewHits",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewHits_ViewedAt",
                table: "ViewHits",
                column: "ViewedAt");
        }
